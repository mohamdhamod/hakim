                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body py-3">
                        <div class="d-flex flex-wrap gap-2 justify-content-center">
                            <a href="{{ route('clinic.patients.create') }}" class="btn btn-outline-primary">
                                <i class="bi bi-person-plus me-1"></i>{{ __('translation.patient.add_new') }}
                            </a>
                            <a href="{{ route('clinic.patients.index') }}" class="btn btn-outline-success">
                                <i class="bi bi-people me-1"></i>{{ __('translation.clinic.stats.total_patients') }}
                            </a>
                            <a href="{{ route('clinic.appointments.index') }}" class="btn btn-outline-info">
                                <i class="bi bi-calendar-check me-1"></i>{{ __('translation.clinic.today_appointments') }}
                            </a>
