...
<div class="bg-light min-vh-100">
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">{{ __('translation.clinic.management') }}</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('translation.dashboard.title') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('translation.clinic.clinics') }}</li>
                    </ol>
                </nav>
            </div>
            <a href="{{ route('clinics.pending') }}" class="btn btn-warning">
        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="clinics-table" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('translation.clinic.status') }}</th>
