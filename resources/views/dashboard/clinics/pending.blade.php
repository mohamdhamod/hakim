        ...
        <div class="row justify-content-start py-3">
            <div class="col-xxl-8 col-xl-10 text-start">
                <span class="badge bg-light text-dark fw-normal shadow px-2 py-1 mb-2">
                    <i class="bi bi-clock-history me-2"></i> {{ __('translation.clinic.pending') }}
                </span>
                <h3 class="fw-bold">{{ __('translation.clinic.pending_approvals') }}</h3>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">{{ __('translation.clinic.pending_approvals') }}</h5>
                        <div class="d-flex gap-2">
                            <a href="{{ route('clinics.index') }}" class="btn btn-sm btn-primary">
                                <i class="bi bi-list me-2"></i> {{ __('translation.clinic.all_clinics') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach($clinics as $clinic)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    @if($clinic->doctor->phone)
                                                        <br><small class="text-muted"><i class="bi bi-telephone"></i> {{ $clinic->doctor->phone }}</small>
                                                    @endif
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <small class="text-muted">{{ $clinic->created_at->format('Y-m-d H:i') }}</small>
                                            </td>
                                            <td class="actions">
                                                <!-- View button -->
                                                <a href="{{ route('clinics.show', ['locale' => app()->getLocale(), 'clinic' => $clinic->id]) }}"
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <h5 class="text-muted">{{ __('translation.clinic.no_pending_clinics') }}</h5>
                                <p class="text-muted mb-0">{{ __('translation.clinic.no_pending_clinics_message') }}</p>
                                <a href="{{ route('clinics.index') }}" class="btn btn-primary mt-3">
                                    <i class="bi bi-list me-2"></i> {{ __('translation.clinic.all_clinics') }}
                                </a>
                            </div>
                        @endif
