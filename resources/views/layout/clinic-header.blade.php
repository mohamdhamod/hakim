    ...
    <div class="container-fluid topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="logo-topbar">
                <a class="logo-dark" href="{{ route('clinic.workspace') }}">
                ...
                <a class="logo-light" href="{{ route('clinic.workspace') }}">
                    <span class="d-flex align-items-center gap-1">
                        <span class="avatar avatar-xs rounded-circle">
                            <span class="avatar-title">
            ...
            <div class="topbar-item d-none d-lg-flex">
                <a class="topbar-link btn shadow-none btn-link px-2" href="{{ route('clinic.workspace') }}">{{ __('translation.clinic.dashboard') }}</a>
            </div>

            <div class="topbar-item d-none d-lg-flex">
                <a class="topbar-link btn shadow-none btn-link px-2" href="{{ route('clinic.patients.index') }}">{{ __('translation.patient.patients') }}</a>
            </div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        @auth
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('clinic.settings') }}">
                                    <i class="bi bi-gear me-2"></i> {{ __('translation.clinic.settings') }}
                                </a>
                            </li>
                        @endauth
                        ...
                        <li>
                            <a class="dropdown-item fw-semibold" href="{{ route('logout') }}" 
                               onclick="event.preventDefault();const f=document.getElementById('logout-form'); if(!f) return; if (f.requestSubmit) { f.requestSubmit(); } else { const ev=new Event('submit',{bubbles:true,cancelable:true}); if (f.dispatchEvent(ev)) f.submit(); }">
                                <i class="bi bi-box-arrow-right me-2"></i>{{ __('translation.auth.logout') }}
                            </a>
                        </li>
